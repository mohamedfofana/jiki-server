...
public class SprintRowMapper extends AbstractRowMapper implements RowMapper<Sprint>{
	...
	public Sprint mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		sprint.setCreationDate(rs.getDate("CREATION_DATE_SP"));
		sprint.setUpdateDate(rs.getDate("UPDATE_DATE_SP"));
		...
		sprint.setStartDate(rs.getDate("START_DATE_SP"));
		sprint.setEndDate(rs.getDate("END_DATE_SP"));
		sprint.setEstimatedEndDate(rs.getDate("ESTIMATED_END_DATE_SP"));
	...
	public Sprint mapRowAssigned(ResultSet rs, int rowNum) throws SQLException {
		...
		sprint.setCreationDate(rs.getDate("CREATION_DATE_SP_ASS"));
		sprint.setUpdateDate(rs.getDate("UPDATE_DATE_SP_ASS"));
		...
		sprint.setStartDate(rs.getDate("START_DATE_SP_ASS"));
		sprint.setEndDate(rs.getDate("END_DATE_SP_ASS"));
		sprint.setEstimatedEndDate(rs.getDate("ESTIMATED_END_DATE_SP_ASS"));
